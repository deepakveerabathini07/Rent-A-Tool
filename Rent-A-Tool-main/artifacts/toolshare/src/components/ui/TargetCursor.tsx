...
const TargetCursor = ({
  ...
  // quickTo setters for zero-lag cursor tracking
  ...
  useEffect(() => {
    ...
    // quickTo for smooth, zero-lag cursor tracking
    quickX.current = gsap.quickTo(cursor, 'x', { duration: 0.06, ease: 'none' });
    quickY.current = gsap.quickTo(cursor, 'y', { duration: 0.06, ease: 'none' });
